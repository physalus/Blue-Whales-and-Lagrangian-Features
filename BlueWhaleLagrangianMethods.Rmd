...
```{r ksOutputIndividuals, echo=TRUE,fig.align = 'center', message=FALSE, warning=FALSE}
...
```{r ftleCRW_Ar1, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE }
# Use previously processed model to save time
...
```{r ftle_glmmCRW_Plot, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
## Figure 3 A #### 
# Random Site Selection Model
ggplot() + 
...
##### 24 Hour Time-Shift
```{r ftleShiftP24_Ar1, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=TRUE, warning=FALSE}
# Use previously processed model to save time
...
##### 48 Hour Time-Shift
```{r ftleShiftP48_Ar1, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=TRUE, warning=FALSE}
# Use previously processed model to save time
...
```{r ftleShiftP96_Ar1, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=TRUE, warning=FALSE}
# Use previously processed model to save time
...
##### 192 Hour Time-Shift
```{r ftleShiftP192_Ar1, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
# Use previously processed model to save time
...
```{r ftleShiftPlotAll, echo=TRUE, fig.align = 'center',fig.height=8, fig.width=12, message=TRUE, warning=FALSE}
ggplot() + 
...
```{r suppTable1, echo=TRUE,fig.align = 'center', fig.width=12, message=FALSE, warning=FALSE}
...
```{r fit_hmm2State, cache = TRUE, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
# Fit HMM
...
```{r plot_hmm_2_Stationary, cache = TRUE, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
...
```{r plotGLMMVSHMM, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
ggplot() +
  geom_ribbon(data=testSet, 
              aes(x=ftle48,ymin = lwr, ymax = upr, 
...
```{r individualFR, echo=TRUE, fig.align = 'center',fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
p1 <- ggplot() +
...
```{r hmmDetermineFRPercentiles, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
...
#### Fit the model:
```{r fit_hmm4state, cache = TRUE, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
# Initial parameters (known states are based on # lunges)
...
```{r plot_hmm_4_Stationary, cache = TRUE, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
...
```{r estimatedFR,cache = TRUE, echo=TRUE,fig.align = 'center', fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
feeding_rates <- 
...
```{r frIncreases,cache=TRUE, echo=TRUE, message=FALSE, warning=FALSE}
# For 5th to 95th 
